...
flowchart LR
  ...
  Arrival --> TerminalCheckpoint["DCA / SFO / EWR / LGA / BOS / ORD / DFW / PHL terminal + checkpoint routing"]
  Arrival --> Generic["8 checkpoint-first airport views"]
